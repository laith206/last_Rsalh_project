                                ...
                                <div class="product_header">
                                    <div class="product_header_left">
                                        <div class="custom_select">
                                            <form action="{{ route('filter_byprice') }}" method="POST">
                                                @csrf
                                                <select class="form-control form-control-sm"  onchange="this.form.submit()" name="sorting">
                                                  @if ($sorting=="all")
                                                  <option name="all" selected="{{ $sorting }}" value="all">Default sorting</option>
                                                  <option name="low"  value="low" >Sort by price: low to high</option>
                                                  <option name="high" value="high" >Sort by price: high to low</option>
                                                  @elseif ($sorting=="low")
                                                  <option name="all"  value="all">Default sorting</option>
                                                  <option name="low" selected="{{ $sorting }}" value="low" >Sort by price: low to high</option>
                                                  <option name="high" value="high" >Sort by price: high to low</option>
                                                  @else
                                                  <option name="all"  value="all">Default sorting</option>
                                                  <option name="low"  value="low" >Sort by price: low to high</option>
                                                  <option name="high" selected="{{ $sorting }}" value="high" >Sort by price: high to low</option>
                                                  @endif
                                        ...
                                        <div class="product_img">
                                            ...
                                            <div class="product_action_box">
                                                <ul class="list_none pr_action_btn">
                                                    <li class="add-to-cart"><a href="{{ route('product.cart') }}"><i
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget">
                                ...
                                <div class="filter_price">
                                    <div id="price_filter" data-min="{{ Myhelper::minprice() }}"
                                        data-max="{{ Myhelper::maxPrice() }}" data-min-value="{{ $first }}"
                                        data-max-value="{{ $second }}" data-price-sign="$"></div>
                                    <div class="price_range">
                                        <span>Price: <span id="flt_price"></span></span>
                                        <form action="{{ route('filter_price') }}" method="POST">
                                            @csrf
                                            <input type="hidden"  name="first" id="price_first" value="{{ $first }}">
                                            <input type="hidden" name="second" id="price_second" value="{{ $second }}">

                                            <input class="btn btn-info btn-sm" type="submit" name="submit" value="Filter">
                                        </form>
