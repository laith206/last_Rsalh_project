                    ...
                    <div class="row no-gutters">
                        <div class="col-sm-5">
                            <div class="background_bg h-100"
                                data-img-src="{{ asset('assets/images/popup_img.jpg') }}">
                            </div>
                        </div>
                        <div class="col-sm-7">
            ...
            <div class="row">
                <div class="topbar-menu-area">
                    <div class="container">
                        ...
                        <div
                            class="topbar-menu right-menu d-flex align-items-center justify-content-center justify-content-md-start">


                            <div class="lng_dropdown mr-2">
                                <select name="countries" class="custome_select">
                                    <option value='en' data-image="{{ asset('assets/images/eng.png') }}"
                                        data-title="English">English
                                    </option>
                                    <option value='fn' data-image="{{ asset('assets/images/fn.png') }}"
                                        data-title="France">France
                                    </option>
                                    <option value='us' data-image="{{ asset('assets/images/us.png') }}"
                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    ...
                                    <li class="menu-item menu-item-has-children parent">
                                        ...
                                        <ul class="submenu curency">
                                            <li class="menu-item">
                                                <a title="Dashbord"
                                                    href="{{ route('admin.dashbord') }}">Dashbord-admin</a>
                                            {{-- </li>
                                            <li class="menu-item">
                                                <a title="categories"
                                            ...
                                            <li class="menu-item">
                                                <a title="manage home slider"
                                                    href="{{ route('homeslider.index') }}">Home-slider</a>
                                            </li> --}}

                                            <li class="menu-item">
                                                <a title="Dashbord" href="{{ route('logout') }}"
                            ...
                            <ul class="navbar-nav">
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul>
                                            <li><a class="dropdown-item nav-link nav_item active" href="/">
                                                    <h5>Fashion 1</h5>
                                                </a></li>
                                            <del>
                                                <li><a class="dropdown-item nav-link nav_item"
                                                        href="index-2.html">Fashion
                                                        2</a></li>
                                                <del>
                                                    <li><a class="dropdown-item nav-link nav_item"
                                                            href="index-3.html">Furniture
                                                            1</a></li>
                                                    <del>
                                                        <li><a class="dropdown-item nav-link nav_item"
                                                                href="index-4.html">Furniture
                                                                2</a></li>
                                                        <del>
                                                            <li><a class="dropdown-item nav-link nav_item"
                                                ...
                                                <ul class="d-lg-flex">
                                                    <li class="mega-menu-col col-lg-4">
                                                        <ul>
                                                            ...
                                                            <li><a class="dropdown-item nav-link nav_item"
                                                                    href="{{ route('shop') }}">Left Sidebar</a>
                                                            </li>
                                                            <del>
                                                                <li><a class="dropdown-item nav-link nav_item"
                                                        ...
                                                        <div class="shop_banner">
                                                            ...
                                                            <div class="shop_bn_content">
                                                                <h5 class="text-uppercase shop_subtitle">New
                                                                    Collection</h5>
                                                                <h3 class="text-uppercase shop_title">Sale 30% Off
                                                                </h3>
                                                                <a href="#"
    ...
    <footer class="footer_dark">
        ...
        <div class="bottom_footer border-top-tran">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p class="mb-md-0 text-center text-md-left">© 2021 All Rights Reserved by RSALH-TEAM</p>
                    </div>
                    <div class="col-md-6">
                        <ul class="footer_payment text-center text-lg-right">
                            <li><a href="#"><img src="{{ 'assets/images/visa.png' }}" alt="visa"></a></li>
                            <li><a href="#"><img src="{{ 'assets/images/discover.png' }}" alt="discover"></a></li>
                            <li><a href="#"><img src="{{ 'assets/images/master_card.png' }}" alt="master_card"></a>
                            </li>
