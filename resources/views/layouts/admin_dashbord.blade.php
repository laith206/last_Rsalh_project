...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/build/css/bootstrap-datetimepicker.min.css') }}">
                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="menu-item">
                                <a title="Dashbord"  href="{{ route('logout') }}"onclick="event.preventDefault();document.getElementById('logout-form').submit();"> <i class="feather icon-log-out"></i>logout</a>
                                    ...
                                    <li class="menu-item menu-item-has-children parent">
                                        ...
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                ...
                                                <li class="menu-item">
                                                    <a title="manage home Catrgory"
                                                        href="{{ route('Homecategories.index') }}">Home-Catrgory</a>
                                                ...
                                                <li class="menu-item">
                                                    <a title="manage home slider"
                                                        href="{{ route('sale_timer') }}">Sale sitting</a>

                                                </li>

                                                <li class="menu-item">
                                                    <a title="Dashbord" href="{{ route('logout') }}"> <i
                                     ...
                                     @else
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                <li class="menu-item">
                                                    <a title="Dashbord"
                                                        href="{{ route('user.dashbord') }}">Dashbord</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a title="Dashbord" href="{{ route('logout') }}">logout</a>
