                            ...
                            <ul>
                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    ...
                                    <li class="menu-item menu-item-has-children parent">
                                        ...
                                        <ul class="submenu curency">
                                             <li class="menu-item">
                                           <a title="Dashbord" href="{{ route('admin.dashbord') }}">Dashbord-admin</a>
                                       </li>
                                       {{-- <li class="menu-item">
                                       ...
                                       <li class="menu-item">
                                           <a title="manage home slider" href="{{ route('admin.homecategory') }}">Home-Catrgory</a>
                                       </li> --}}
                                    ...
                                    <div class="cart_box dropdown-menu dropdown-menu-right">
                                        ...
                                        <div class="cart_footer">
                                            ...
                                            <p class="cart_buttons"><a href="#"
                                                    ...
                                                    href="#" class="btn btn-fill-out rounded-0 checkout">Checkout</a>
                                            </p>
                                        </div>
                                    </div>
                                </li>
