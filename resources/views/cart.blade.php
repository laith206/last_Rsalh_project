                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-name" data-title="Product"><a href="{{route('product.details',['slug'=>$item->model->slug])}}">{{$item->model->name}}</a>
                                        </td>
                                        <td class="product-price" data-title="Price">{{$item->model->regular_price}}</td>
                                        <td class="product-quantity" data-title="Quantity">
                                            <div class="quantity">
                                                <input type="button" value="-" class="minus" click.prevent="increaseQuantity('{{$item->rowId}}')">
                                                <input type="text" name="product-quatity" value="{{$item->qty}}" data-max="120" pattern="[0-9]*" title="Qty" class="qty"
                                                    size="4">
