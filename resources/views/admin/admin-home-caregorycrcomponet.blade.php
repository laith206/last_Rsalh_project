                        ...
                        <form class="form-horizontal" wire:submit.prevent="updateHomeCategory()">
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <select name="categories[]" id="selectCategory" multiple="multiple"
                                        class="form-control sel_categories" wire:model="select_categories">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-md" wire:model="products_no">
                                </div>
                            </div>
                            <div class="form-group">
