            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form wire:submit.prevent="storeSlider()" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="title" class="col-md-4 control-label">
                                    Title
                                </label>
                                <div class="col-md-4">
                                    <input type="text" wire:model="title" id="title" class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="number" wire:model="price" id="price" class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" wire:model="link" id="link" class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" wire:model="image" id="image" class="input-file">
                                    {{-- <span class="text-danger">@error('image'){{ $message }} @enderror</span> --}}
                                    @if ($image)
                                        <img src="{{ $image->temporaryUrl() }}" alt="slider image" width="100">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
